    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRMRoles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoleAssignments_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_RoleAssignments_HRMRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "HRMRoles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalRules_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalSteps_ApprovalRules_ApprovalRuleId",
                        column: x => x.ApprovalRuleId,
                        principalTable: "ApprovalRules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApprovalSteps_HRMRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "HRMRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PiiTags = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VirusScanned = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalRules_DepartmentId",
                table: "ApprovalRules",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalRules_EntityType_BranchId_DepartmentId",
                table: "ApprovalRules",
                columns: new[] { "EntityType", "BranchId", "DepartmentId" });

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalSteps_ApprovalRuleId_StepOrder",
                table: "ApprovalSteps",
                columns: new[] { "ApprovalRuleId", "StepOrder" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_Code_BranchId",
                table: "Departments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Positions_Code_DepartmentId",
                table: "Positions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleAssignments_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleAssignments_UserId_RoleId_BranchId",
                table: "RoleAssignments",
                columns: new[] { "UserId", "RoleId", "BranchId" });

            migrationBuilder.CreateIndex(
                name: "IX_Settings_Key_Environment_Version",
                table: "Settings",
                columns: new[] { "Key", "Environment", "Version" });

            migrationBuilder.AddForeignKey(
                name: "FK_ApprovalRules_Departments_DepartmentId",
                table: "ApprovalRules",
                column: "DepartmentId",
                principalTable: "Departments",
                principalColumn: "Id",
